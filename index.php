...
<div id="mySidebar" class="sidebar">
    ...
    <div>
        <a href="Inicio.php" data-no-warning>Inicio</a>
        <a href="dashboard.php" data-no-warning>Contáctenos</a>
        <a href="consulta_general.php" data-no-warning>Quiénes Somos</a>
        <a href="ubicacion.php" data-no-warning>Ubicación</a>
        <a href="registro.php" data-no-warning>Regístrate</a>
    </div>
</div>
