...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-03-2025 a las 01:14:48
...
INSERT INTO `clientes` (`Cedula_Id`, `Nombre`, `Apellido`, `Teléfono`, `Email`) VALUES
...
INSERT INTO `empleados` (`Cedula_Empleado_id`, `Nombre`, `Apellido`, `Contraseña`, `Rol_id`, `Teléfono`, `Email`, `intentos_fallidos`, `fecha_hora_bloqueo`) VALUES
(1010, 'brian', 'rendon', '$2y$10$JQSVWMvzAwNhiA0JYD0fM.uUxZzylPV2Xx/7fp214BmOwTtSRSs1.', 2, NULL, NULL, 0, NULL),
(1040, 'edwin', 'sanchez', '$2y$10$dGu8U8jqn6E1BAhIqHk3Fe484U83cG7c/PfCpYi5mfxia5R17tTw6', 1, NULL, NULL, 0, NULL),
(2025, 'patricia', 'patiño', '$2y$10$aiUAA6oEMZVf.YpYhBRwUOOBgbpFV0fm8f6o5.zQQiiqkDA/RcMzK', 3, NULL, NULL, 0, NULL),
(4040, 'Super', 'Admin', '$2y$10$F22tgMXGlfLCFN2dRocsWOOlfWflEXeIbDcCJtfJXsEwMhnpRLtmS', 0, NULL, NULL, 0, NULL);
...
(1, NULL, 'ABC123', 1, '2024-10-01', 'Avenida 122, Ciudad F', 'Cambio de llantas necesario', 'llanta_abc123.jpg', 'Cambio de llantas delantero y trasero', 'Custodia en taller', 1),
(32, NULL, 'ABC123', 1, '2024-11-06', 'Poli JIC', 'Motor con sobrecalentamiento', 'carro.img', 'Reparación del sistema de enfriamiento', 'Custodia en taller hasta reparación', 1),
...
(43, NULL, 'JKL112', 5, '2024-11-05', 'Calle 70, Ciudad O', 'Revisión de frenos', 'frenos_jkl112.jpg', 'Ajuste del sistema de frenos', 'Custodia en taller hasta revisión', 1),
...
('ABC123', 'Toyota', 'Corolla', 'Rojo', 'GPS, Radio', 11111),
('DEF456', 'Toyota', 'Corolla', 'Gris', 'Herramientas', 22222),
...
--
ALTER TABLE `servicios_realizados`
  MODIFY `Servicio_Realizado_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
